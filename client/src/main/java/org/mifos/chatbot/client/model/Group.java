...
import org.mifos.chatbot.client.model.Group;
import org.mifos.chatbot.client.model.GroupLevel;
...
public class Group {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, staff, parent, groupLevel, clientMembers, submittedOnDate, accountNumberRequiresAutoGeneration, childGroup, group, center, active, closed, transferInProgress, transferInProgressOrOnHold, notPending, notActive, activationLocalDate, transferOnHold, pending, activeClientMembers, _new);
  }
