...
public class Client {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, transferToOffice, image, status, firstname, middlename, lastname, displayName, externalId, staff, groups, accountNumberRequiresAutoGeneration, closureDate, withdrawalDate, submittedOnDate, legalForm, reopenedDate, active, closed, withdrawn, transferInProgress, transferInProgressOrOnHold, officeJoiningLocalDate, notPending, rejectedDate, rejected, notActive, activationLocalDate, transferOnHold, pending, notStaff, _new);
  }
