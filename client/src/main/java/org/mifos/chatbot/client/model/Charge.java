...
import org.mifos.chatbot.client.model.MonthDay;
import org.mifos.chatbot.client.model.TaxGroup;
...
public class Charge {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, amount, currencyCode, chargeTimeType, chargeCalculation, chargePaymentMode, feeInterval, penalty, active, deleted, minCap, maxCap, account, taxGroup, savingsCharge, feeOnMonthDay, annualFee, loanCharge, monthlyFee, clientCharge, overdueInstallment, percentageOfApprovedAmount, disbursementCharge, percentageOfDisbursementAmount, allowedSavingsChargeTime, allowedSavingsChargeCalculationType, allowedLoanChargeTime, allowedClientChargeTime, allowedClientChargeCalculationType, _new);
  }
