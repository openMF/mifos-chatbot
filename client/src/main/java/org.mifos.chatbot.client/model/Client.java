...
public class Client {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, transferToOffice, image, status, firstname, middlename, lastname, displayName, externalId, staff, groups, accountNumberRequiresAutoGeneration, closureDate, withdrawalDate, submittedOnDate, legalForm, reopenedDate, active, closed, rejected, rejectedDate, notActive, pending, withdrawn, transferInProgress, transferOnHold, transferInProgressOrOnHold, notPending, activationLocalDate, officeJoiningLocalDate, notStaff, _new);
  }
