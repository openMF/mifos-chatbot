...
public class LoanProduct {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, shortName, loanProductRelatedDetail, includeInBorrowerCycle, startDate, closeDate, externalId, minimumDaysBetweenDisbursalAndFirstRepayment, productInterestRecalculationDetails, loanProductGuaranteeDetails, principalThresholdForLastInstallment, installmentAmountInMultiplesOf, floatingRates, currency, accountingType, accrualBasedAccountingEnabled, minNominalInterestRatePerPeriod, maxNominalInterestRatePerPeriod, minNumberOfRepayments, maxNumberOfRepayments, repaymentStrategy, loanProductCharges, loanProductConfigurableAttributes, principalAmount, minPrincipalAmount, maxPrincipalAmount, arrearsBasedOnOriginalSchedule, multiDisburseLoan, interestRecalculationEnabled, numberOfRepayments, nominalInterestRatePerPeriod, interestPeriodFrequencyType, linkedToFloatingInterestRate, cashBasedAccountingEnabled, upfrontAccrualAccountingEnabled, accountingDisabled, periodicAccrualAccountingEnabled, holdGuaranteeFundsEnabled, _new);
  }
