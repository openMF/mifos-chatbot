...
public class LoanProductRelatedDetail {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currency, principal, nominalInterestRatePerPeriod, interestPeriodFrequencyType, annualNominalInterestRate, interestMethod, interestCalculationPeriodMethod, allowPartialPeriodInterestCalcualtion, repayEvery, repaymentPeriodFrequencyType, numberOfRepayments, graceOnPrincipalPayment, graceOnInterestPayment, amortizationMethod, inArrearsTolerance, graceOnArrearsAgeing, arrearsTolerance, interestRecalculationEnabled, graceOnDueDate);
  }
