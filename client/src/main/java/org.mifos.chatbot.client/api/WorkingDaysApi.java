...
import org.mifos.chatbot.client.model.GetWorkingDaysResponse;
import org.mifos.chatbot.client.model.GetWorkingDaysTemplateResponse;
import org.mifos.chatbot.client.model.PutWorkingDaysRequest;
import org.mifos.chatbot.client.model.PutWorkingDaysResponse;
...
public class WorkingDaysApi {
    ...
    public WorkingDaysApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WorkingDaysApi(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call retrieveAllCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/workingdays";
     ...
     */
    public List<GetWorkingDaysResponse> retrieveAll() throws ApiException {
        ApiResponse<List<GetWorkingDaysResponse>> resp = retrieveAllWithHttpInfo();
        return resp.getData();
    }
     ...
     * List Working days
     * Example Requests:  workingdays
     * @return ApiResponse&lt;List&lt;GetWorkingDaysResponse&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<GetWorkingDaysResponse>> retrieveAllWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = retrieveAllValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<GetWorkingDaysResponse>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List Working days (asynchronously)
     * Example Requests:  workingdays
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call retrieveAllAsync(final ApiCallback<List<GetWorkingDaysResponse>> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call templateCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/workingdays/template";
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetWorkingDaysTemplateResponse template() throws ApiException {
        ApiResponse<GetWorkingDaysTemplateResponse> resp = templateWithHttpInfo();
        return resp.getData();
    }
     ...
     * Working Days Template
     * This is a convenience resource. It can be useful when building maintenance user interface screens for working days.  Example Request:  workingdays/template
     * @return ApiResponse&lt;GetWorkingDaysTemplateResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetWorkingDaysTemplateResponse> templateWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = templateValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<GetWorkingDaysTemplateResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Working Days Template (asynchronously)
     * This is a convenience resource. It can be useful when building maintenance user interface screens for working days.  Example Request:  workingdays/template
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call templateAsync(final ApiCallback<GetWorkingDaysTemplateResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateCall(PutWorkingDaysRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateValidateBeforeCall(PutWorkingDaysRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PutWorkingDaysResponse update(PutWorkingDaysRequest body) throws ApiException {
        ApiResponse<PutWorkingDaysResponse> resp = updateWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * Mandatory Fields recurrence,repaymentRescheduleType,extendTermForDailyRepayments,locale
     * @param body body (required)
     * @return ApiResponse&lt;PutWorkingDaysResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PutWorkingDaysResponse> updateWithHttpInfo(PutWorkingDaysRequest body) throws ApiException {
        com.squareup.okhttp.Call call = updateValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<PutWorkingDaysResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update a Working Day (asynchronously)
     * Mandatory Fields recurrence,repaymentRescheduleType,extendTermForDailyRepayments,locale
     * @param body body (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAsync(PutWorkingDaysRequest body, final ApiCallback<PutWorkingDaysResponse> callback) throws ApiException {
