...
/**
 * API tests for SpmServeysApi
 */
@Ignore
public class SpmServeysApiTest {

    private final SpmServeysApi api = new SpmServeysApi();
...
//        List<SurveyData> response = api.fetchActiveSurveys();
     ...
     */
    @Test
    public void findSurveyTest() throws ApiException {
        Long id = null;
